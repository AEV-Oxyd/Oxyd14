...
job-name-cadet = Ironhammer Cadet
...
job-name-detective = Ironhammer Inspector
...
job-name-security = Ironhammer Operative
...
job-name-warden = Ironhammer Gunnery Sergeant
