...
Status: **In progress** (Milestones 1–3 verified; M4 Packet A UI verified; B–F pending)
...
| 4. Bible UI and common effects | **In progress** | Packet A Verified (`LitanyUiTest` 9/9 @ `7cf78157be`). Packet B (Relief/SoulHunger) Verified: `LitanyEffectsMedicalTest` 6/6 (1 dirty-pool skip; isolation re-run green). Only those two Implemented+enabled; others fail-closed. Packets C–F pending. |
