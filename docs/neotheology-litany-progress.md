...
| 4. Bible UI and common effects | **In progress** | Packet A (Bible UI shell + two-viewer privacy) **Verified**: `LitanyUiTest` **9/9**. Catalog still 0 IsAvailable / Implemented empty. Packets B–F effect families pending. |
